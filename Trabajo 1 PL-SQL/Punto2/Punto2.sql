...
BEGIN
  ...
  DBMS_OUTPUT.PUT_LINE('Informe para ' || v_tipo_producto || ' por año y marca: ' || CHR(9));
  ...
  LOOP
    ...
    DBMS_OUTPUT.PUT_LINE('marca' || CHR(9) || CHR(9) || CHR(9) || 'totalpesos');
    ...
    LOOP
      ...
      IF v_total_pesos != 0 THEN
        IF lENGTH(v_marca) > 10 THEN
          DBMS_OUTPUT.PUT_LINE(v_marca || CHR(9) || CHR(9) || v_total_pesos || CHR(13));
        ELSE
          DBMS_OUTPUT.PUT_LINE(v_marca || CHR(9) || CHR(9)  || CHR(9) || v_total_pesos || CHR(13));
        END IF;
      END IF;
    END LOOP;
